...
export class AppComponent {
  ...
  analyzeGitRepo() {
    ...
    this.http.post<AnalysisResponse>('https://codeanalysis-42512.web.app/run-analyzer', requestBody)
      .pipe(
        catchError(error => {
  ...
  uploadLocalRepo() {
    ...
    this.http.post<AnalysisResponse>('https://codeanalysis-42512.web.app/run-analyzer', formData)
      .pipe(
        catchError(error => {
          console.error('Error:', error);
          return throwError(error);
